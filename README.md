...
[![MCPize](https://mcpize.com/badge/@raghavmittal429/graph)](https://mcpize.com/mcp/graph)
...
```bash
npx -y mcpize connect @raghavmittal429/graph --client claude
```

Or connect at: **https://mcpize.com/mcp/graph**
